...
<qgis labelsEnabled="1" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.4.2-Madeira" simplifyAlgorithm="0" simplifyLocal="1" minScale="1e+08" simplifyDrawingHints="0" maxScale="0" readOnly="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" attr="VEL_V" symbollevels="1" enableorderby="0" graduatedMethod="GraduatedColor" type="graduatedSymbol">
    <ranges>
  ...
  <labeling type="simple">
    <settings>
      <text-style fontWordSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWeight="75" fontStrikeout="0" textOpacity="0.97" blendMode="0" fontUnderline="0" fontSizeUnit="Point" previewBkgrdColor="#ffffff" namedStyle="fed" fieldName="format_number(&quot;VEL_V&quot;,2) || ' mm/yr' &#xd;&#xa;" useSubstitutions="0" fontLetterSpacing="0" fontCapitals="0" isExpression="1" fontItalic="0" fontFamily="MS Shell Dlg 2" fontSize="6.5" textColor="255,255,255,255" multilineHeight="1">
        ...
        <Option type="Map">
          ...
          <Option type="Map" name="properties">
            <Option type="Map" name="Color">
              <Option value="true" type="bool" name="active"/>
              <Option value="if(&quot;VEL_V&quot;>0, color_rgb(0,110,180), color_rgb(220,0,35))" type="QString" name="expression"/>
              <Option value="3" type="int" name="type"/>
            </Option>
          </Option>
          <Option value="collection" type="QString" name="type"/>
